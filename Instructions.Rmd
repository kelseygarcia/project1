...
4. Make visualizations (three plots)
    ...
    - , (don't make the same kind of plot twice)
...
- Use all six core `dplyr` functions in the service of generating summary tables/statistics (14 pts)
    ...
    - Use at least one `stringr` function with to do something with regex ## what does this mean???
...
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
